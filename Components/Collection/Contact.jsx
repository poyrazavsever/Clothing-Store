...
function Contact() {
    return (
        <div className='h-screen bg-neutral-200 relative flex items-start justify-between pb-32'>
            ...
            <div className='w-1/2 relative py-12 flex flex-col items-start gap-8 pl-12 xl:pl-0 z-30'>
                ...
                <div className='flex flex-col items-start gap-8'>
                    ...
                    <div className="w-80 flex flex-col gap-3">
                        ...
                        <textarea id="name" placeholder='Explain why you would like to purchase this collectible' className='w-full h-52 px-4 py-2 rounded-sm bg-neutral-200 focus:outline-none border border-neutral-600 placeholder:text-sm placeholder:tracking-wide placeholder:text-zinc-500 text-black' />
                    </div>
