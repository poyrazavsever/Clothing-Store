            ...
            <div className='flex items-center justify-between container mx-auto'>
                ...
                <div className='flex items-center justify-center gap-8'>
                    ...
                    <ul className='flex items-center justify-center gap-5'>
                        ...
                        <li><a href="/" className={linkStyle} onMouseEnter={() => setHoverLink("man")} onMouseLeave={() => setHoverLink("")}>Man</a></li>
                        <li><a href="/" className={linkStyle} onMouseEnter={() => setHoverLink("woman")} onMouseLeave={() => setHoverLink("")}>Woman</a></li>
                        <li><a href="/" className={linkStyle} onMouseEnter={() => setHoverLink("kids")} onMouseLeave={() => setHoverLink("")}>Kids</a></li>
