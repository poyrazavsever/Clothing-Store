      ...
      <div className='h-full relative flex items-start justify-between'>
        ...
        <div className='h-full flex flex-col items-start justify-center gap-4 w-1/2 z-30  container mx-auto '>
          ...
          <p className='text-neutral-200 text-sm tracking-wide'>
            ...
            Growing up, Emily pursued her passion, studying fashion design at a prestigious university. After graduating, she worked with some of the top names in the industry, gaining invaluable experience and honing her craft. Despite her success, Emily felt a deep desire to create something uniquely her own, something that would reflect her vision of luxury and timeless fashion.
            In 2020, Luxe Threads was launched. From its inception, the brand aimed to combine contemporary trends with classic elegance, offering a curated collection that speaks to modern sophistication. Each piece in the Luxe Threads collection is meticulously crafted, using the finest materials and paying attention to every detail.
            Luxe Threads quickly gained recognition for its exquisite designs and impeccable quality. The brand's commitment to sustainability and ethical fashion also set it apart in the industry. Luxe Threads collaborates with renowned designers and artisans worldwide, ensuring each piece is not only stylish but also responsibly made...
          </p>
